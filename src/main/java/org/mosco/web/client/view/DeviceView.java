 ...
 */
package org.mosco.web.client.view;
...
import org.mosco.web.client.model.BaseStoreHandlers;
import org.mosco.web.client.model.DeviceStore;
import org.mosco.web.client.model.GeoFenceProperties;
import org.mosco.web.client.model.GroupStore;
import org.mosco.web.client.state.DeviceVisibilityChangeHandler;
import org.mosco.web.client.state.DeviceVisibilityHandler;
...
public class DeviceView implements RowMouseDownEvent.RowMouseDownHandler, CellDoubleClickEvent.CellDoubleClickHandler {
    ...
    interface Resources extends ClientBundle {
        @Source("org/mosco/web/client/theme/icon/eye.png")
        ImageResource eye();

        @Source("org/mosco/web/client/theme/icon/follow.png")
        ImageResource follow();

        @Source("org/mosco/web/client/theme/icon/footprints.png")
