...
import org.mosco.web.client.model.ReportService;
import org.mosco.web.client.model.ReportServiceAsync;
import org.mosco.web.client.view.NavView;
import org.mosco.web.client.view.ReportsDialog;
import org.mosco.web.client.view.ReportsMenu;
import org.mosco.web.shared.model.Device;
import org.mosco.web.shared.model.GeoFence;
...
public class ReportsController implements ContentController, ReportsMenu.ReportHandler {
    ...
    private void generate(Report report) {
        ...
        form.setAction("mosco/report" + (report.isPreview() ? "/" + report.getName() + ".html" : ""));
