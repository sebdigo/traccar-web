...
import org.mosco.web.client.view.CommandDialog;
import org.mosco.web.client.view.DeviceView;
import org.mosco.web.client.view.LogViewDialog;
import org.mosco.web.shared.model.Command;
import org.mosco.web.shared.model.CommandType;
...
public class CommandController implements ContentController, DeviceView.CommandHandler, CommandDialog.CommandHandler {
    ...
    public void onSend(Device device,
        ...
        RequestBuilder builder = new RequestBuilder(RequestBuilder.POST, "mosco/rest/sendCommand");
