...
public interface DataService extends RemoteService {
    ...
    User login(String login, String password, boolean passwordHashed) throws moscoException;

    User login(String login, String password) throws moscoException;
    ...
    Device addDevice(Device device) throws moscoException;

    Device updateDevice(Device device) throws moscoException;
    ...
    GeoFence addGeoFence(GeoFence geoFence) throws moscoException;

    GeoFence updateGeoFence(GeoFence geoFence) throws moscoException;
