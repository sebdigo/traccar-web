 ...
 */
package org.mosco.web.server.reports;
...
public class ReportRenderer {
    ...
    public void start(Report report) throws IOException {
        ...
        IOUtils.copy(Thread.currentThread().getContextClassLoader().getResourceAsStream("org/mosco/web/server/reports/bootstrap.min.css"),
                writer, "UTF-8");
        line("</style>");
