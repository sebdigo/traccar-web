...
public class ExportServlet extends HttpServlet {
    ...
    void csv(HttpServletResponse response, Locale locale, Device device, Date from, Date to, boolean filter) throws IOException, AccessDeniedException {
        ...
        response.setHeader("Content-Disposition", "attachment; filename=mosco-positions.csv");
    ...
    void gpx(HttpServletResponse response, Device device, Date from, Date to, boolean filter) throws IOException, XMLStreamException, AccessDeniedException {
        ...
        response.setHeader("Content-Disposition", "attachment; filename=mosco-positions.gpx");
        ...
        xsw.writeAttribute("xmlns:mosco", "http://www.mosco.org");
        xsw.writeAttribute("creator", "mosco WEB UI");
        ...
        xsw.writeAttribute("href", "https://github.com/vitalidze/mosco-web");
        xsw.writeStartElement("text");
        xsw.writeCharacters("mosco WEB UI");
        xsw.writeEndElement();
        xsw.writeEndElement();
        ...
        xsw.writeCharacters("mosco archive");
        xsw.writeEndElement();
