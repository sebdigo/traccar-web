...
public class ServerMessages {
    ...
    public ServerMessages() throws IOException {
        defaultMessages.load(Thread.currentThread().getContextClassLoader().getResourceAsStream("org/mosco/web/client/i18n/Messages.properties"));
    }
    ...
    public String message(String locale, String key) {
        ...
        if (localeMessages == null) {
            ...
            InputStream messagesIS = Thread.currentThread().getContextClassLoader().getResourceAsStream("org/mosco/web/client/i18n/Messages_" + locale + ".properties");
            if (messagesIS == null) {
