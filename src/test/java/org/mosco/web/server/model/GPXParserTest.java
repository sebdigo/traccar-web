...
public class GPXParserTest {
    @Test
    public void testmoscoOutput() throws XMLStreamException, ParseException, IOException {
        for (String file : new String[] {"test_mosco.gpx", "test_mosco_json.gpx"}) {
            GPXParser.Result r = new GPXParser().parse(getClass().getResourceAsStream("/org/mosco/web/server/model/" + file), null);
            assertNotNull(r);
    ...
    public void testForeign() throws XMLStreamException, ParseException, IOException {
        GPXParser.Result r = new GPXParser().parse(getClass().getResourceAsStream("/org/mosco/web/server/model/test_foreign.gpx"), null);
        assertNotNull(r);
        assertNotNull(r.positions);
    ...
    public void testWithForeignExtensions() throws XMLStreamException, ParseException, IOException {
        GPXParser.Result r = new GPXParser().parse(getClass().getResourceAsStream("/org/mosco/web/server/model/test_foreign_ext.gpx"), null);
