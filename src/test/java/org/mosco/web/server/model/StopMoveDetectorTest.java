...
import static org.mosco.web.server.model.EventServiceImpl.*;
...
import org.mosco.web.shared.model.DeviceEvent;
...
public class StopMoveDetectorTest {
    ...
    List<Position> readIdlePositions() throws XMLStreamException, ParseException, IOException {
        return new GPXParser().parse(getClass().getResourceAsStream("/org/mosco/web/server/model/idle_device.gpx"), null).positions;
    }
    ...
    List<Position> readMovingPositions() throws XMLStreamException, ParseException, IOException {
        return new GPXParser().parse(getClass().getResourceAsStream("/org/mosco/web/server/model/moving_device.gpx"), null).positions;
    }
