...
import static org.mosco.web.server.model.PasswordUtils.*;
import static org.mosco.web.shared.model.PasswordHashMethod.*;
...
import org.mosco.web.client.model.NotificationService;
...
public class DataServiceTest {
    ...
    @Test
    public void testDeleteDeviceWithSpecificGeoFence() throws moscoException {
    ...
    @Test
    public void testDeleteUserWithNotificationSettings() throws moscoException {
    ...
    @Test
    public void testDeleteUserWithNotificationSettingsAndTemplate() throws moscoException {
        Long originalUserId = injector.getProvider(User.class).get().getId();
    ...
    @Test
    public void testResetPasswordByAdmin() throws moscoException {
        User user = new User("test", "test");
        user = dataService.addUser(user);
    ...
    @Test
    public void testResetPasswordByManager() throws moscoException {
    ...
    @Test
    public void testDeleteManagerUser() throws moscoException {
        Long originalUserId = injector.getProvider(User.class).get().getId();
